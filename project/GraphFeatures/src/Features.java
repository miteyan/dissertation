...
public class Features {
    ...
    public String string() {
        return nodes +
                ...
                ", " + varClusteringCoefficient +
                ", " + meanNodeBetweennessCentrality +
                ", " + varNodeBetweennessCentrality +
                ", " + meanShortestPathLength +
                ", " + varShortestPathLength +
                ", " + meanEdgeBetweenessCentrality +
                ", " + varEdgeBetweenessCentrality +
                ", " + meanPagerank +
                ", " + varPagerank;
    }

...
train_dataset, test_dataset, valid_dataset = ds.get_data(dataset, 0.1, 0.1, 0.35)
...
num_iters = 100
optimized_model = RandomizedSearchCV(clf, param_distributions=param_dist, n_iter=num_iters)

# hyper parameter optimization
start = time()
optimized_model.fit(valid_dataset, valid_labels)
